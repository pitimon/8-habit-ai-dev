...
- The affected file(s) and version (check the `Version` badge in [`README.md`](README.md) or `.claude-plugin/plugin.json`)
...
Update before reporting: `claude plugin update 8-habit-ai-dev@pitimon-8-habit-ai-dev`.
