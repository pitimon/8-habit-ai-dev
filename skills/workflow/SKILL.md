...
- See [`docs/INTEGRATION.md`](https://github.com/pitimon/8-habit-ai-dev/blob/main/docs/INTEGRATION.md) for the full integration matrix between this plugin, `devsecops-ai-team`, and `claude-governance`.
