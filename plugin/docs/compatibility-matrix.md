...
| Hermes Skills Hub tap packaging           | No                                                 | No                                                                                                                                                                                                                 | Install-only — `hermes skills tap add pitimon/8-habit-ai-dev`, then `hermes skills install pitimon/8-habit-ai-dev/skills/<name>`; supporting `guides/`/`habits/`/`scripts/` references need the substitution URL each affected `SKILL.md` carries as of v2.21.46 ([#388](https://github.com/pitimon/8-habit-ai-dev/issues/388)) |
